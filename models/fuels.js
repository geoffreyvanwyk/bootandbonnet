...
/**
  * For working with the fuels database table.
  */
...
var fuels = Object.defineProperties({}, {
	/* Data properties */
	types: {
		value: [],
		writable: true,
	...
	readTypes: {
		value: function (callback) {
			var that = this;
			db.query("SELECT type FROM fuels", function (err, rows, fields) {
				if (err) {
					return callback(err);
				}
...
Object.preventExtensions(fuels);
