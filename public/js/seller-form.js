window.onload = function() {
    ...
    document.getElementById("provinces").onchange = function() {
        ...
        var provinces = JSON.parse(document.getElementById("locationsString").value);
        for (p in provinces) {
    ...
    /**
     * Returns true if the user has specified which type of seller he/she is; false, otherwise.
     */
    ...
    /**
     * Returns true if the user has specified a province; false, otherwise.
     */
    ...
    /**
     * Returns true if the user has specified a town; false, otherwise.
     */
    ...
    document.getElementById("register").onsubmit = function() {
        ...
        var isDealership = document.getElementById("dealership").checked;
